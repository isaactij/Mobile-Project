...
class CreateTaskViewController: UIViewController {
    ...
    func addTask(description:String){
        ...
        let task:Tasks = Tasks(taskID: index, taskDescription: description, taskDeadlineDate: deadlineDateTextField.text!, taskDeadlineTime: deadlineTimeTextField.text!, taskReminderDate: reminderDateTextField.text!, taskReminderTime: reminderTimeTextField.text!, personID: currentUserID)
