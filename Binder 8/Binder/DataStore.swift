...
class DataStore {
        ...
        ref.child("tasks").observeSingleEvent(of: .value, with: { (snapshot) in
            ...
            if let theTasks = value {
                for p in theTasks {
                    ...
                    let personIDforObject = Int(personID!)
                    let newTask = Tasks(taskID:taskIDforObject!, taskDescription:taskDescription!, taskDeadlineDate:taskDeadlineDate!, taskDeadlineTime:taskDeadlineTime!, taskReminderDate:taskReminderDate!, taskReminderTime:taskReminderTime!, personID:personIDforObject!)
    ...
    func updateTask(task: Tasks, newDescription: String, newDeadlineDate: String, newDeadlineTime:String, newReminderDate: String, newReminderTime: String, samePersonID:Int){
